defmodule ShitposterBackend.Web.Endpoint do
  ...
  plug Plug.Static,
    at: "/", from: :shitposter_backend, gzip: false,
    only: ~w(css fonts images static js favicon.ico robots.txt service-worker.js)
  ...
  plug Corsica, [origins: "*", allow_headers: :all, allow_credentials: true]
